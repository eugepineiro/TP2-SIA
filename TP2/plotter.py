...
def update_plots(generation, fit_min, fit_mean, gen_div):
    ...
    ax1.plot(x_vals, fit_min_vals, label="Fitness minimum value",color="cornflowerblue")
    ax1.legend(loc="upper left",frameon=False)

    ax2.cla()
    
    ax2.plot(x_vals, fit_mean_vals, label="Fitness mean value",color="indianred")
    ax2.legend(loc="upper left",frameon=False)
    ax3.cla()
    
    ax3.plot(x_vals, gen_div_vals, label="Genetic diversity value",color="darkorange")
